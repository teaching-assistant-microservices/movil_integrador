class AppRoutes {
  ...
  static const String uploadDocumentPath = '/upload-document';
  static const String documentDetailPath = '/documents/:documentId';
  
  static const String groupingDetailPath = '/groupings/:groupingId';
  static const String recommendationsPath = '/groupings/:groupingId/recommendations';
  ...
  // Helper methods
  static String getDocumentDetailPath(String documentId) => '/documents/$documentId';
  static String getGroupingDetailPath(String groupingId) => '/groupings/$groupingId';
  static String getRecommendationsPath(String groupingId) => '/groupings/$groupingId/recommendations';
  static String getReportPreviewPath(String reportId) => '/reports/$reportId/preview';
}